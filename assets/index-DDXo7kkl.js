...
const UNIQUE_NUMBER_MAX_LENGTH = 4;
...
const STEP_ORDER = ["uniqueNumber", "company", "expirationDate", "cvcNumber", "password"];
const ERROR_MESSAGE = {
...
const useUniqueNumber = () => {
  const [uniqueNumber, setUniqueNumber] = reactExports.useState(["", "", "", ""]);
...
const validateExpirationDate = (type, value) => {
...
const useErrorCheckComplete = (isError) => {
  return reactExports.useMemo(() => {
    return isError.every((error) => !error);
  }, [isError]);
};
const useExpirationDateValidation = () => {
  const [isError, setIsError] = reactExports.useState([false, false]);
  const [errorMessage, setErrorMessage] = reactExports.useState("");
  const validateInput = (index, value) => {
    const type = index === 0 ? "MM" : "YY";
...
const PreviewCard = ({ cardInformationState }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { css: previewCardStyle(company), children: [
    /* @__PURE__ */ jsxs("div", { css: TopStyle, children: [
      /* @__PURE__ */ jsx$1("div", { css: magneticStyle }),
      cardType !== "none" && /* @__PURE__ */ jsx$1("img", { css: cardImageStyle, src: separateCard[cardType], alt: cardType })
    ] }),
    /* @__PURE__ */ jsxs("div", { css: cardInformationStyle, children: [
      /* @__PURE__ */ jsx$1("div", { css: uniqueNumberStyle, children: uniqueNumber.map(
        (number, index) => index < 2 ? /* @__PURE__ */ jsx$1("span", { css: numberStyle, children: number }, index) : /* @__PURE__ */ jsx$1("span", { css: dotStyle, children: number && "·".repeat(number.length) }, index)
      ) }),
...
const previewCardStyle = (company) => css`
  width: 212px;
  height: 132px;
  border-radius: 4px;
...
const Select = ({
  ...
  const [isSelect, setIsSelect] = reactExports.useState(false);
  const [selected, setSelected] = reactExports.useState(placeholder);
  ...
  return /* @__PURE__ */ jsxs("div", { css: selectStyle, ref: selectRef, children: [
    /* @__PURE__ */ jsxs("button", { type: "button", css: labelStyle(isOpen, isSelect), onClick: () => setIsOpen((prev2) => !prev2), children: [
      selected,
      /* @__PURE__ */ jsx$1("img", { src: arrow[isOpen ? "down" : "up"], alt: "" })
    ] }),
...
`;
const labelStyle = (isOpen, isSelect) => css`
  min-height: 32px;
  display: flex;
  align-items: center;
  justify-content: space-between;
...
const FormSectionSelect = (props) => {
  ...
  return /* @__PURE__ */ jsx$1(FormSection, { title, description, children: /* @__PURE__ */ jsx$1(Select, { ...fieldData }) });
};
const FormSectionSelect$1 = React.memo(FormSectionSelect);
...
const ErrorMessage = ({ error, message }) => {
  return /* @__PURE__ */ jsx$1("div", { css: errorTextWrapperStyle(error), children: /* @__PURE__ */ jsx$1(Text, { type: "error", text: message || "유효하지 않은 값입니다." }) });
};
...
const moveFocusOrBlur = ({
  ...
  if (isLastInput) {
    (_a = inputRefs[index]) == null ? void 0 : _a.blur();
  } else {
    (_b = inputRefs[index + 1]) == null ? void 0 : _b.focus();
  }
};
const InputField = ({
  label,
  ...
  return /* @__PURE__ */ jsxs("div", { css: inputFieldStyle, children: [
    ...
    /* @__PURE__ */ jsx$1(ErrorMessage, { error: isError.some((bool) => bool === true), message: errorMessage })
  ] });
};
...
const FormSectionInput = (props) => {
  const { title, description, fieldData } = props;
  return /* @__PURE__ */ jsx$1(FormSection, { title, description, children: /* @__PURE__ */ jsx$1(InputField, { ...fieldData }) });
};
const FormSectionInput$1 = React.memo(FormSectionInput);
const Button = ({ type = "button", text, onClick }) => {
  return /* @__PURE__ */ jsx$1("button", { type, css: buttonStyle, onClick, children: text });
};
...
const FormContainer = ({
  ...
  return /* @__PURE__ */ jsxs("form", { css: FormContainerStyle, onSubmit, children: [
    formUIControllerData.slice(0, step + 1).reverse().map((formSectionData) => {
      if (formSectionData.key === "company") {
        ...
        const setState = setCardInformationState[key];
    ...
    /* @__PURE__ */ jsx$1("div", { css: ButtonWrapperStyle, children: complete && /* @__PURE__ */ jsx$1(Button, { type: "submit", text: "완료" }) })
  ] });
};
...
const ButtonWrapperStyle = css`
  ...
  z-index: 99;
`;
const useStep = (isStateCompletes, isErrorCompletes) => {
...
const useAllComplete = (isStateCompletes, isErrorCompletes) => {
  return reactExports.useMemo(() => {
...
const AddCard = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { css: ContainerStyle$1, children: [
    /* @__PURE__ */ jsx$1(PreviewCard, { cardInformationState }),
    /* @__PURE__ */ jsx$1(
      FormContainer,
      {
        cardInformationState,
...
const CompleteCard = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { css: ContainerStyle, children: [
    /* @__PURE__ */ jsx$1("img", { src: "completeIcon.svg", alt: "complete" }),
    /* @__PURE__ */ jsx$1(Text, { type: "complete", text: `${uniqueNumber}로 시작하는
${company}가 등록되었어요.` }),
    /* @__PURE__ */ jsx$1(Button, { text: "확인", onClick: () => navigate("/") })
  ] });
};
...
`;
const Router = () => {
  return /* @__PURE__ */ jsx$1(BrowserRouter, { basename: "/react-payments/", children: /* @__PURE__ */ jsxs(Routes, { children: [
    /* @__PURE__ */ jsx$1(Route, { path: "/", element: /* @__PURE__ */ jsx$1(AddCard, {}) }),
    /* @__PURE__ */ jsx$1(Route, { path: "/complete", element: /* @__PURE__ */ jsx$1(CompleteCard, {}) })
  ] }) });
};
ReactDOM.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsx$1(React.StrictMode, { children: /* @__PURE__ */ jsx$1(Router, {}) })
);
